...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cetak'])) {
    $laporantittle = "Data Laporan Evaluasi Keseluruhan Kelas";

    $query = "SELECT tb_kelas.id_kelas, tb_kelas.nama_kelas, 
                    ...
                    <div
                        ...
                        <div class="col-sm-6 col-lg-8">
                            <div class="card text-center">
                                <div class="card-body">
                                    <form action="laporan-keseluruhan.php" method="post">
                                        <h5 class="card-title">Cetak Laporan Keseluruhan Evaluasi Kelas</h5>
